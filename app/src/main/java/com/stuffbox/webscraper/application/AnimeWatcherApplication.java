package com.stuffbox.webscraper.application;
 ...
 */
public class AnimeWatcherApplication extends Application {
    ...
    private synchronized void initDownloadManager() {
        if (downloadManager == null) {
            databaseProvider = new ExoDatabaseProvider(getApplicationContext());
